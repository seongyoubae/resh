...
def get_cfg():
    ...
    parser.add_argument("--T_horizon", type=int, default=300, help="Number of steps to collect per update, step in episode")
    ...
    parser.add_argument("--save_every", type=int, default=10, help="Save model every x episodes")
    ...
    parser.add_argument("--noise_level", type=float, default=0.01, help="State augmentation noise level (0 to disable)")
