...
def get_cfg():
    ...
    parser.add_argument("--n_epoch", type=int, default=20, help="Total number of epochs")
    ...
    parser.add_argument("--save_every", type=int, default=15, help="Save model every x episodes")
