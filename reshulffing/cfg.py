...
def get_cfg():
    ...
    parser.add_argument("--actor_lr", type=float, default=0.00001, help="Learning rate for actor network")
    parser.add_argument("--critic_lr", type=float, default=0.00001, help="Learning rate for critic network")
    ...
    parser.add_argument("--T_horizon", type=int, default=400, help="Number of steps to collect per update, step in episode")
    parser.add_argument("--episodes_per_epoch", type=int, default=128, help="Number of episodes to collect per epoch, mini batch size")
    parser.add_argument("--mini_batch_size", type=int, default=400, help="Fixed size of minibatches per PPO update, same with T_horizon")
    ...
    parser.add_argument("--save_model_dir", type=str, default="/output/saved_models", help="Directory within /output to save models for vessl")
    ...
    parser.add_argument("--outbound_extra_max", type=int, default=10, help="Maximum extra for outbound relative to inbound")
