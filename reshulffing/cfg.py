...
def get_cfg():
    ...
    parser.add_argument("--actor_lr", type=float, default=0.00005, help="Learning rate for actor network")
    parser.add_argument("--critic_lr", type=float, default=0.00005, help="Learning rate for critic network")
    ...
    parser.add_argument("--save_every", type=int, default=50, help="Save model every x episodes")
    parser.add_argument("--save_final_state_every", type=int, default=10000, help="Save final state every x episodes")
    parser.add_argument("--new_instance_every", type=int, default=800, help="Generate new scenarios every x episodes")
