...
def get_cfg():
    ...
    parser.add_argument("--T_horizon", type=int, default=100, help="Number of steps to collect per update, step in episode")
    parser.add_argument("--episodes_per_epoch", type=int, default=128, help="Number of episodes to collect per epoch, mini batch size")
    parser.add_argument("--mini_batch_size", type=int, default=100, help="Fixed size of minibatches per PPO update, same with T_horizon")
