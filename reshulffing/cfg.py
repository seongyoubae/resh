...
def get_cfg():
    ...
    parser.add_argument("--n_epoch", type=int, default=5100, help="Total number of epochs")
    ...
    parser.add_argument("--new_instance_every", type=int, default=30, help="Generate new scenarios every x episodes")
