...
def get_cfg():
    ...
    parser.add_argument("--critic_lr", type=float, default=0.0003, help="Learning rate for critic network")
    ...
    parser.add_argument("--T_horizon", type=int, default=330, help="Number of steps to collect per update, step in episode")
    parser.add_argument("--episodes_per_epoch", type=int, default=64, help="Number of episodes to collect per epoch, mini batch size")
    parser.add_argument("--mini_batch_size", type=int, default=330, help="Fixed size of minibatches per PPO update, same with T_horizon")
    ...
    parser.add_argument("--save_final_state_every", type=int, default=50000, help="Save final state every x episodes")
    ...
    # 데이터 생성 관련
    parser.add_argument("--num_plates", type=int, default=330, help="Number of plates for schedule generation")
