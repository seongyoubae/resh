...
def get_cfg():
    ...
    parser.add_argument("--critic_lr", type=float, default=0.001, help="Learning rate for critic network")
    ...
    parser.add_argument("--save_every", type=int, default=100, help="Save model every x episodes")
